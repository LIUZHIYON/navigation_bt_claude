...
execute_process(
  COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "release-1.12.1"
  WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/groot2_project/navigation_bt/build_msvc/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/groot2_project/navigation_bt/build_msvc/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
