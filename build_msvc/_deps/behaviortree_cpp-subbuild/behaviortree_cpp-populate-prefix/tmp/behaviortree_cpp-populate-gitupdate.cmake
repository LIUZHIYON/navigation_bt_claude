...
function(do_fetch)
  ...
  execute_process(
    COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
...
execute_process(
  COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "4.0.2"
  WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4.0.2" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 4.0.2")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/4.0.2")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"4.0.2\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
...
execute_process(
  COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src'."
    ...
    execute_process(
      COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "E:/Git/mingw64/bin/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/groot2_project/navigation_bt/build_msvc/_deps/behaviortree_cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
